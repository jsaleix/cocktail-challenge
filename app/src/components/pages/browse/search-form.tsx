...
export default function SearchForm({}: Props) {
  return (
    <form className="flex flex-col items-center flex-wrap md:flex-nowrap md:flex-row justify-between gap-5">
      <SearchInput placeholder="Cocktail name" className="w-full md:w-1/3" />
      ...
      <button className="w-fit hover:opacity-80 duration-300">
        <svg
          width="26"
          height="26"
          viewBox="0 0 26 26"
